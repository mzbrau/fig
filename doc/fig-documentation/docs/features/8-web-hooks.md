...
| Health Status Changed       | Clients report their health back to Fig. When their health changes, this web hook is called and it includes details of their health including the healh of sub-components. | [Github](TODO)                                               | /HealthStatusChanged       |

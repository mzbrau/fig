...
Fig 4.0 is not yet the default published docs version, but the current (Next) documentation describes 4.0 behaviour. Use this page when you upgrade from 3.x.

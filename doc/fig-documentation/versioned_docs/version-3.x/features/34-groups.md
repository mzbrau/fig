...
![Groups Page](./img/groups-page.png)  
...
Each grouped setting has a **Value Type** (e.g., `System.String`, `System.Int32`) that defines the data type of the underlying settings.

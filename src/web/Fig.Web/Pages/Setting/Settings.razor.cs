...
public partial class Settings : ComponentBase, IAsyncDisposable
{
    ...
    private Func<Task>? _settingsLoadedCallback;
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        {
            // Defer display scripts so the settings list can paint first.
        ...
        // Flush the loading-complete UI before running display scripts so the list can paint.
        await InvokeAsync(StateHasChanged);
        await Task.Yield();
        ...
        _settingsLoadedCallback = () => InvokeAsync(() =>
        {
    ...
    private void SetUpKeyboardShortcuts()
    {
        ...
        _hotKeysContext.Add(ModCode.Alt, Code.D, (Func<ValueTask>)(async () => await ShowDescription(SelectedSettingClient)));

...
async Task BuildApplication(WebAssemblyHostBuilder builder)
{
    ...
    builder.Services.AddScoped<IDashboardAssistantActionQueue, DashboardAssistantActionQueue>();
    ...
    builder.Services.AddSingleton<Fig.Web.Dashboards.Schema.IDashboardSchemaMigrator, Fig.Web.Dashboards.Schema.DashboardSchemaMigrator>();

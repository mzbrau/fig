...
builder.Services.AddTransient<ICertificateImporter, CertificateImporter>();
...
builder.Services.AddSingleton<ICertificateMetadataConverter, CertificateMetadataConverter>();

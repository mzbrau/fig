...
[TestFixture]
public class LegacyCodeHasherTests
{
    private Mock<IOptions<ApiSettings>> _mockApiSettings = null!;
    private LegacyCodeHasher _legacyCodeHasher = null!;
    ...
    public void SetUp()
    {
        ...
        _legacyCodeHasher = new LegacyCodeHasher(_mockApiSettings.Object);
    }
    ...
    public void GetHash_WithValidCode_ShouldReturnHash()
    {
        ...
        // Act
        var hash = _legacyCodeHasher.GetHash(code);
    ...
    {
        // Act & Assert
        var ex = Assert.Throws<ArgumentException>(() => _legacyCodeHasher.GetHash(null!));
    ...
    {
        // Act & Assert
        var ex = Assert.Throws<ArgumentException>(() => _legacyCodeHasher.GetHash(string.Empty));
        Assert.That(ex!.Message, Does.Contain("Code cannot be null or empty"));
        Assert.That(ex.ParamName, Is.EqualTo("code"));
    }
    ...
    {
        // Act & Assert
        var ex = Assert.Throws<ArgumentException>(() => _legacyCodeHasher.GetHash("   "));
        Assert.That(ex!.Message, Does.Contain("Code cannot be null or empty"));
        Assert.That(ex.ParamName, Is.EqualTo("code"));
    }
    ...
    public void GetHash_WithNullSecret_ShouldThrowInvalidOperationException()
    {
        ...
        _mockApiSettings.Setup(x => x.Value).Returns(apiSettings);
        var codeHasher = new LegacyCodeHasher(_mockApiSettings.Object);
    ...
    public void IsValid_WithValidCodeAndHash_ShouldReturnTrue()
    {
        ...
        // Act
        var result = _legacyCodeHasher.IsValid(hash, code);
    ...
    public void IsValid_WithInvalidCode_ShouldReturnFalse()
    {
        ...
        // Act
        var result = _legacyCodeHasher.IsValid(hash, "wrong-code");
    ...
    public void IsValid_WithNullCode_ShouldReturnFalse()
    {
        ...
        // Act
        var result = _legacyCodeHasher.IsValid(hash, null);
    ...
    public void IsValid_WithEmptyCode_ShouldReturnFalse()
    {
        ...
        // Act
        var result = _legacyCodeHasher.IsValid(hash, string.Empty);
    ...
    public void IsValid_WithWhitespaceCode_ShouldReturnFalse()
    {
        ...
        // Act
        var result = _legacyCodeHasher.IsValid(hash, "   ");
    ...
    {
        // Act
        var result = _legacyCodeHasher.IsValid(null!, "test-code");
    ...
    {
        // Act
        var result = _legacyCodeHasher.IsValid(string.Empty, "test-code");
    ...
    {
        // Act
        var result = _legacyCodeHasher.IsValid("   ", "test-code");

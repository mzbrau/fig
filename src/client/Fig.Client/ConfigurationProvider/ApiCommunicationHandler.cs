...
public class ApiCommunicationHandler : IApiCommunicationHandler
{
    ...
    private async Task<IEnumerable<CustomActionClientPollResponseDataContract>?> PollForCustomActionRequests()
    {
    ...
    private async Task SendCustomActionResults(CustomActionClientExecuteRequestDataContract results)
    {

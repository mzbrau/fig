...
/// <summary>
/// Helper class for working with custom category enums.
/// Provides methods to extract category name and color from custom enums decorated with CategoryNameAttribute and ColorHexAttribute.
/// </summary>

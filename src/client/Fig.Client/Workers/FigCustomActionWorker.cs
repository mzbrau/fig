...
namespace Fig.Client.Workers
{
    public class FigCustomActionWorker<T> : IHostedService
    {
        ...
        private async Task HandleRequest(CustomActionClientPollResponseDataContract request, CancellationToken cancellationToken)
        {
            ...
            if (matchingAction is not null)
            {
                ...
                try
                {
                    ...
                    {
                        var executeRequest = new CustomActionClientExecuteRequestDataContract
                        {
                ...
                catch (Exception ex)
                {
                    ...
                    if (CustomActionBridge.SendCustomActionResults is not null)
                    {
                        ...
                        {
                            ExecutionId = request.RequestId,
                            Results = new List<CustomActionResultDataContract>(),
                            Success = false
                        };
